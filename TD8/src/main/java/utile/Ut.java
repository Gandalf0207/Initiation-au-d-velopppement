package TD8.src.main.java.utile;// dmaj : 13 septembre 2025
...
public class Ut {
    ...
    public static int saisirEntier(String m) {
        System.out.print("\n" + m);
        return saisirEntier();
    }
    ...
    public static double saisirDouble(String m) {return saisirReel(m);}
    ...
    public static double saisirReel(String m) {
        System.out.println("\n" + m);
        return saisirReel();
    }
    ...
    public static float saisirFlottant(String m) {
    ...
    public static char saisirCaractere(String m) {
        System.out.println("\n" + m);
    ...
    public static boolean saisirBooleen(String m) {
        System.out.println("\n" + m);
        return saisirBooleen();
    }
    ...
    public static String saisirChaine(String m) {
        System.out.println("\n" + m);
        return saisirChaine();
    }
